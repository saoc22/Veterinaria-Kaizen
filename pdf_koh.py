...
def generar_koh(valores):
  ...
  pdf.cell(w=0, h=15, txt='KOH', border=0, ln=1, align='C', fill=0)
  ...
  y1 = pdf.get_y()
  pdf.set_xy(x1+6, y1)
  pdf.set_font('RalewayB', '', 18)
  pdf.set_text_color(255, 255, 255)
  pdf.set_fill_color(4, 22, 49)
  pdf.cell(w=176, h=8, txt='Resultados:', border='LRBT', align='C', ln=1, fill=1)
  y1 = pdf.get_y()
  pdf.set_xy(x1+6, y1)
  pdf.set_font('Raleway', '', 10)
  pdf.set_text_color(0, 0, 0)
  pdf.multi_cell(w=176, h=5, txt=valores['resultados'], border='LRBT', align='L', fill=0)
  ...
  if valores['comen'] != '':
    ...
    pdf.set_text_color(255, 255, 255)
    pdf.set_fill_color(4, 22, 49)
    pdf.cell(w=176, h=8, txt='Comentario:', border='LRBT', align='C', ln=1, fill=1)
    y1 = pdf.get_y()
    pdf.set_xy(x1+6, y1)
    pdf.set_font('Raleway', '', 10)
