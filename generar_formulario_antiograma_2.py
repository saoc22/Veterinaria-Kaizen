...
def crear_formato_antiograma_completo():
    ...
    for i in range(0, 29, 4):
      ...
      cb_i = QCheckBox("I")
      cb_r = QCheckBox("R")
      cb_s.setStyleSheet(estilo_checkbox)
      cb_i.setStyleSheet(estilo_checkbox)
      cb_r.setStyleSheet(estilo_checkbox)
      cb_s1 = QCheckBox("S")
      cb_i1 = QCheckBox("I")
      cb_r1 = QCheckBox("R")
      cb_s1.setStyleSheet(estilo_checkbox)
      cb_i1.setStyleSheet(estilo_checkbox)
      cb_r1.setStyleSheet(estilo_checkbox)
      cb_s2 = QCheckBox("S")
      cb_i2 = QCheckBox("I")
      cb_r2 = QCheckBox("R")
      cb_s2.setStyleSheet(estilo_checkbox)
      cb_i2.setStyleSheet(estilo_checkbox)
      cb_r2.setStyleSheet(estilo_checkbox)

      # Crear un grupo de botones exclusivos
      grupo_sir = QButtonGroup(widget_principal)
      grupo_sir.setExclusive(True)  # Asegura que solo uno puede ser seleccionado a la vez
      grupo_sir.addButton(cb_s)
      grupo_sir.addButton(cb_i)
      grupo_sir.addButton(cb_r)

      # Crear un grupo de botones exclusivos
      grupo_sir1 = QButtonGroup(widget_principal)
      grupo_sir1.setExclusive(True)  # Asegura que solo uno puede ser seleccionado a la vez
      grupo_sir1.addButton(cb_s1)
      grupo_sir1.addButton(cb_i1)
      grupo_sir1.addButton(cb_r1)

      # Crear un grupo de botones exclusivos
      grupo_sir2 = QButtonGroup(widget_principal)
      grupo_sir2.setExclusive(True)  # Asegura que solo uno puede ser seleccionado a la vez
      grupo_sir2.addButton(cb_s2)
      grupo_sir2.addButton(cb_i2)
      grupo_sir2.addButton(cb_r2)
      ...
      layout_vertical1.addWidget(cb_s)
      layout_vertical1.addWidget(cb_i)
      layout_vertical1.addWidget(cb_r)
      layout_horizontal2.addLayout(layout_vertical1)

      layout_horizontal3.addWidget(label3)
      layout_vertical2.addWidget(cb_s1)
      layout_vertical2.addWidget(cb_i1)
      layout_vertical2.addWidget(cb_r1)
      layout_horizontal3.addLayout(layout_vertical2)

      layout_horizontal4.addWidget(label4)
      layout_vertical3.addWidget(cb_s2)
      layout_vertical3.addWidget(cb_i2)
      layout_vertical3.addWidget(cb_r2)
      layout_horizontal4.addLayout(layout_vertical3)
